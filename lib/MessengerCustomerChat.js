...
const removeElementByIds = function removeElementByIds(ids) {
  ids.forEach(id => {
...
const MessengerCustomerChat = (function(_Component) {
    ...
    return (
      (_ret =
        ...
        (_this.componentDidUpdate = function(prevProps) {
          if (
            prevProps.pageId !== _this.props.pageId ||
            prevProps.appId !== _this.props.appId ||
            prevProps.shouldShowDialog !== _this.props.shouldShowDialog ||
            prevProps.htmlRef !== _this.props.htmlRef ||
            prevProps.minimized !== _this.props.minimized ||
            prevProps.themeColor !== _this.props.themeColor ||
            prevProps.loggedInGreeting !== _this.props.loggedInGreeting ||
            prevProps.loggedOutGreeting !== _this.props.loggedOutGreeting ||
            prevProps.greetingDialogDisplay !==
              _this.props.greetingDialogDisplay ||
            prevProps.greetingDialogDelay !== _this.props.greetingDialogDelay ||
            prevProps.autoLogAppEvents !== _this.props.autoLogAppEvents ||
            prevProps.xfbml !== _this.props.xfbml ||
            prevProps.version !== _this.props.version ||
            prevProps.language !== _this.props.language
          ) {
        ...
        (_this.loadSDKAsynchronously = function() {
          const language = _this.props.language;
      /* eslint-disable */
      ...
      /* eslint-enable */
        ...
        (_this.controlPlugin = function() {
          const shouldShowDialog = _this.props.shouldShowDialog;
